...
const HTB = () => {
  return (
    <div>
      <Navbar />
      <HeroImageResponsive imageSrc={heroImg} heroText={"Celebrate Someone Special"} heroText2={"Make a Lasting Impact"} />
      <div className="container py-5">
        <div className="row align-items-center d-flex justify-content-center mb-2 mt-2">
            ...
            <div className="flex align-items-start flex-column">
              <div className="pt-1 mt-3 pb-1">
                ...
                <div className={styles.paragraph}>
                  <p><b>The Raleigh Police Department Foundation</b> is steadfast in its mission to build a safer, stronger Raleigh – one where trust,
